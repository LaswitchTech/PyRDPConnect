...
class FreeRDP(QObject):
    ...
    def __init__(
        ...
        self._configuration.add("freerdp.devices.input", "On the remote computer", "select", label="Record Sound", choices=["Never", "On this computer", "On the remote computer"])
    ...
    def build_command(
        ...
        # Devices / audio
        play_sound = val("freerdp.devices.output", "On this computer")
        record_sound = val("freerdp.devices.input", "On the remote computer")
        printers = bool(val("freerdp.devices.printers", False))
        smart_cards = bool(val("freerdp.devices.smart_cards", False))
        ports_redirect = bool(val("freerdp.devices.ports", True))
        camera_redirect = bool(val("freerdp.devices.camera", True))
        drives = bool(val("freerdp.devices.drives", True))

        # Experience
        clipboard = bool(val("freerdp.experience.clipboard", True))
        remotefx = bool(val("freerdp.experience.remotefx", False))
        smooth_fonts = bool(val("freerdp.experience.smooth_fonts", True))
        desktop_comp = bool(val("freerdp.experience.desktop_composition", True))
        full_window_drag = bool(val("freerdp.experience.full_window_drag", True))
        menu_anims = bool(val("freerdp.experience.menu_animations", True))
