...
class FreeRDP:
    def __init__(self, helper: Helper, config: Configuration, logger: Log):
        ...
        self._configuration.add("freerdp.devices.output", "On this computer", "select", choices=["Never", "On this computer", "On the remote computer"])
        self._configuration.add("freerdp.devices.input", "On this computer", "select", choices=["Never", "On this computer", "On the remote computer"])
